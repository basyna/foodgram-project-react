...
# Дипломный проект на курсе Яндекс Практикум
## Проект доступен по адресу [51.250.99.198](http://51.250.99.198/)
Для теста Админ панели использовать login: admin пароль: 654987
